...
sul mercato come \href{https://www.pentestgpt.ai/}{PentestGPT}, fanno uso di modelli altamente specializzati, addestrati su dataset specifici 
...
\begin{itemize}
    ...
    gestire il training in batch ragionevoli.
...
possa automaticamente ripetere comandi passati, e la completa rivisitazione del
sistema che gestisce l'input e l'output, per permette di vedere in tempo reale i messaggi
del modello, riducendo notevolmente i tempi di attesa.\\
Oltre a questo sono state aggiunte nuove funzionalità come la ricerca di CVE su \href{https://nvd.nist.gov/}{NVD} e resa più
...
È prevista l'aggiunta di nuovi moduli, come un Modulo 
